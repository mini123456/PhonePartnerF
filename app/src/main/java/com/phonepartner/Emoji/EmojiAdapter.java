 ...
 * @创建时间	: 2017-1-27 下午02:34:01
 * @文件描述	: 表情填充器
 ******************************************
 */
//仅在  EmojiRelativeLayout 中被调用
public class EmojiAdapter extends BaseAdapter {

    private List<EmojiEntity> data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        EmojiEntity emoji=data.get(position);
        ViewHolder viewHolder=null;
        if(convertView == null) {
            viewHolder=new ViewHolder();
            convertView=inflater.inflate(R.layout.item_eomji, null);
